...
//自动帧率设置	
	{0x0e,0x01},//Auto frame 方面的设置， Auto frame rate control OFF
//手动帧率设置 BEGIN---------------------------------------------
	{0x11,0x06},//Internal Clock，pre-scalar; PLL分频器, Finternal= Finput/(Bit[5:0]+1)/2   2:143帧  3:107帧  4:88帧
	{0x0d,0xc1},//PLL 倍频
